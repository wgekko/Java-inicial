 ...
 * @author WALTER GOMEZ
 */
public class EGG_Java_MaterialExtraZEj_Superficie {
    ...
    public static void main(String[] args) {
        ...
        SuperficieControl sup1 = new SuperficieControl();
        //Superficie sup2=  sup1.CargarYValidar();
        
       
       // sup1.EsPuntoInterno(A1x,A1y,A2x,A2y,A3x,A3y);
        //sup1.TienePuntosInternos(A1x,A1y,A2x,A2y,A3x,A3y, coordX, coordY, cantDeElementos);
        //sup1.SuperficieTriangulo(A1x,A1y,A2x,A2y,A3x,A3y);
        //sup1.semiperimetro(A1x,A1y,A2x,A2y,A3x,A3y);
        //sup1.distancia(A1x,A1y,A2x,A2y);
        //sup1.EvaluarTriangulos(coordX, coordY, cantDeElementos);
    }
